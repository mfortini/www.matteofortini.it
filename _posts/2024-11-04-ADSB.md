...
Nel 2013 Salvatore Sanfilippo, uno sviluppatore italiano meglio conosciuto come [antirez](https://github.com/antirez) e come l'inventore di [Redis](https://redis.io/), ha sviluppato un software molto efficiente per la decodifica delle comunicazioni ADS-B attraverso un sistema RTL-SDR, che ha chiamato [Dump1090](https://github.com/antirez/dump1090).
...
I dati ricevuti sono raccolti da vari siti, che mostrano la posizione e la storia di tutti gli areomobili su cui hanno informazioni. Alcuni di essi sono [Flightaware](https://www.flightaware.com/adsb/coverage/), [Flightradar24](https://www.flightradar24.com/42.86,13.81/6), [OpenSky](https://opensky-network.org/).
