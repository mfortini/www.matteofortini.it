...
Nel 2012, Salvatore Sanfilippo, uno sviluppatore italiano meglio conosciuto come l'inventore di [Redis](https://redis.io/), ha sviluppato un software molto efficiente per la decodifica delle comunicazioni ADS-B attraverso un sistema RTL-SDR, che ha chiamato [Dump1090](https://github.com/antirez/dump1090).
